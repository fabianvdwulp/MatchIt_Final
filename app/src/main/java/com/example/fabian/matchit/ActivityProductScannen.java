...
public class ActivityProductScannen extends ABaseActivity {
                    ...
                    public void run() {
                        if (beacons != null) {
                            for (int i = 0; i < beacons.size(); i++) {
                                ...
                                if(major.equals("11105")){
                                    mPager.setCurrentItem(0);
                                }
                                else if(major.equals("18267")){
                                    mPager.setCurrentItem(1);
                                }
                                else if(major.equals("23328")){
    ...
    public void onNewIntent(Intent intent) {
        ...
        // Checken of tag wel product info bevta
        String stProductId = null;
        try {
            JSONObject joNFC = new JSONObject(s);
        ...
        if(stProductId != null){
            ...
            Toast.makeText(getApplicationContext(), getResources().getString(R.string.productFalse), Toast.LENGTH_SHORT).show();
        }
