...
public class OrderlineRefresh2 {
    ...
    ActivityProductSingle FShoppingCartSelected;
    ...
    public OrderlineRefresh2(ActivityProductSingle aShoppingCartSelected)
    {
    ...
    private class getOrderId extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                Log.i("total1",  GlobalVariables.SHOPPING_TOTAL);
                GlobalVariables.SHOPPING_TOTAL = joPriceProducts.getString("Value");
                Log.i("total2",  GlobalVariables.SHOPPING_TOTAL);
